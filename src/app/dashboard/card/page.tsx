...
const transactions = [
  ...
  { id: "3", merchant: "KFC Manda Hill", category: "food", amount: -185.0, date: "Yesterday", status: "completed" },
];
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto p-4">
      ...
      <div className="rounded-3xl p-6 text-white shadow-xl"
        ...
        {cardLocked && (
          <div className="bg-black/50 absolute inset-0 flex items-center justify-center rounded-3xl">
            <Lock />
          </div>
        )}
      </div>
      ...
      <div className="grid grid-cols-4 gap-3">
        ...
        <button onClick={() => setShowDetails(!showDetails)} className="p-3 bg-white rounded-xl">
        ...
        <button onClick={() => setCardLocked(!cardLocked)} className="p-3 bg-white rounded-xl">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-green-100 p-4 rounded-xl">
          <p>Money In</p>
          <p className="font-bold">+ZMW {totalIn}</p>
        </div>

        <div className="bg-red-100 p-4 rounded-xl">
          <p>Money Out</p>
          <p className="font-bold">-ZMW {totalOut}</p>
        </div>
      </div>
